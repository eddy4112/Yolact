...
my_dataset = dataset_base.copy({
  ...
  'train_info': './data/coco/annotations/2014/train/captions_train2014.json',
  'train_images': './data/coco/annotations/2014/train/images/',
  'valid_info': './data/coco/annotations/2014/val/captions_val2014.json',
  'valid_images': './data/coco/annotations/2014/val/images/',
...
cig_butts_dataset = dataset_base.copy({
  'name': 'Immersive Limit - Cigarette Butts',
  'train_info': './data/coco/annotations/cig_butts/train/coco_annotations.json',
  'train_images': './data/coco/annotations/cig_butts/train/images/',
  'valid_info': './data/coco/annotations/cig_butts/val/coco_annotations.json',
  'valid_images': './data/coco/annotations/cig_butts/val/images/',
  'class_names': ('cig_butt'),
  'label_map': { 1:  1 }
})
